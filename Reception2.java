...
public class Reception2 extends JFrame {
	...
	public Reception2(){
		...
		btnNewButton_4.setBounds(10, 110, 200, 30);
		...
		btnNewButton_5.setBounds(10, 150, 200, 30);
		...
		btnNewButton_6.setBounds(10, 190, 200, 30);
		...
		btnPickUpSerice.setBounds(10, 230, 200, 30);
		...
		contentPane.add(btnSearchRoom);
                ...
                JButton btnFoodOrder = new JButton("Food Order");
		...
		btnFoodOrder.setBounds(10, 310, 200, 30);
                btnFoodOrder.setBackground(Color.BLACK);
                btnFoodOrder.setForeground(Color.WHITE);

		contentPane.add(btnFoodOrder);
                
                JButton btnNewButton_9 = new JButton("All Food Info");
		btnNewButton_9.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try{
				
					FoodInfo em = new FoodInfo();
					em.setVisible(true);
					setVisible(false);
		...
		btnNewButton_9.setBounds(10, 350, 200, 30);                
